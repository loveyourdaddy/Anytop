'''
현재는 single motion에 대해서 retarget(generate)만 가능
   추후, joint embedding을 만든후 다양한 source motion에 대해서도 retarget 가능하도록 수정 예정
...
def main(args=None, cond_dict=None):
    ...
    # Set target
    # args.target_type = "Bear"
    # args.object_type = [args.target_type] # args.source_type
    args.object_type = [args.source_type] # args.source_type
